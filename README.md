# RSDate
En esta librería se encuentras dos componentes, uno para obtener la fecha actual del sistema y el otro para obtener la hora actual del sistema

<img src="https://github.com/RojeruSan/RSDate/blob/RojeruSan/imagen.PNG">
